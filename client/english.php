...
$_LANG['wbteampro']['filelist']['download'] = 'Download';
$_LANG['wbteampro']['filelist']['fileview'] = 'View in Browser';
...
$_LANG['wbteampro']['pagenav']['print'] = 'Print';
$_LANG['wbteampro']['pagenav']['orderby'] = 'Order by %1$s'; // %1$s = Field, %2$s = Direction
...
$_LANG['wbteampro']['listoption']['project_type']['internal'] = 'Internal';
$_LANG['wbteampro']['listoption']['project_type']['product'] = 'Product';
$_LANG['wbteampro']['listoption']['project_type']['service'] = 'Service';
$_LANG['wbteampro']['listoption']['project_status']['service'] = 'Service';
$_LANG['wbteampro']['listoption']['project_status']['under_review'] = 'Under Review';
$_LANG['wbteampro']['listoption']['project_status']['active'] = 'Active';
$_LANG['wbteampro']['listoption']['project_status']['in_production'] = 'In Production';
$_LANG['wbteampro']['listoption']['project_status']['in_testing'] = 'In Testing';
$_LANG['wbteampro']['listoption']['project_status']['completed'] = 'Completed';
$_LANG['wbteampro']['listoption']['project_status']['closed'] = 'Closed';
$_LANG['wbteampro']['listoption']['action_type']['planning'] = 'Planning';
$_LANG['wbteampro']['listoption']['action_type']['research'] = 'Research';
$_LANG['wbteampro']['listoption']['action_type']['contact'] = 'Contact';
$_LANG['wbteampro']['listoption']['action_type']['service'] = 'Service';
$_LANG['wbteampro']['listoption']['action_type']['development'] = 'Development';
$_LANG['wbteampro']['listoption']['action_type']['review'] = 'Review';
$_LANG['wbteampro']['listoption']['action_status']['closed'] = 'Closed';
$_LANG['wbteampro']['listoption']['action_status']['active'] = 'Active';
$_LANG['wbteampro']['listoption']['action_status']['progress'] = 'Progress';
$_LANG['wbteampro']['listoption']['action_status']['cancelled'] = 'Cancelled';
$_LANG['wbteampro']['listoption']['action_status']['complete'] = 'Complete';
